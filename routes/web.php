...
Route::middleware(['guest', 'chace_auth'])->group(function () {
    Route::get('/', [AuthWebController::class, 'index'])->name('login');
    Route::get('/login', [AuthWebController::class, 'v_login']);
});

Route::post('/login', [AuthWebController::class, 'login'])->name('login.post');

Route::middleware(['auth', 'chace_auth'])->group(function () {
    ...
    // SETTING
    Route::get('/setting', [PengaturanWebController::class, 'index'])->name('setting');
    Route::put('/setting/update', [PengaturanWebController::class, 'update'])->name('setting.update');
